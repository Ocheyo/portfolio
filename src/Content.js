...
const contents = {
  Home: (
    <div>
      ...
      <p>As a software engineer, I enjoy bringing my particular creative and intuitive approach to problem solving. I really enjoy algorithms, reminiscent of workign through puzzle books as a child. Brain teasers and riddles were addicting. Now, code challenges and app development provide that rush.</p>
      <p>I started out with BASIC, writing build-your-own-adventure book style games to send to classmates. I moved on to VBA for Excel and worte macros to make life easier at my family's print shop. From there, I went on learn Javascript and web development, which is still my passion.</p>
